...
// }
    ...
    async function getCurrentTrack() {
      ...
      if (data.is_playing) {
        ...
        // Jeśli nie odtwarzana jest piosenka
        // const lastPlayedTimestamp = Date.parse(data.played_at);
        ...
        const lastPlayedTimestamp = data.timestamp;
        console.log("jestesmy w elsie");
        const currentTime = new Date().getTime();
        const timeDifference = currentTime - lastPlayedTimestamp;
